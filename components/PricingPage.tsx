...
const PLANS: Plan[] = [
  {
    ...
    features: [
      ...
      { text: '12,000+ instances tracked', included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Full CSV export (all 12,000+ rows)', included: true },
...
const FAQ: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: 'GPU $/hr is only part of the bill. TMC adds storage, egress, and billed-when-stopped costs to show your real monthly spend — with provider-specific data for all 19+ providers.',
  },
  {
