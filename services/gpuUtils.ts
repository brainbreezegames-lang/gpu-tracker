...
const GPU_TFLOPS_TABLE: [RegExp, number][] = [
  ...
  [/V100/i,               62],
  [/T4\b/i,               65],
  [/RTXPRO6000|RTX[\s_-]PRO[\s_-]6000/i, 3578],  // RTX PRO 6000 Blackwell 96GB (no Ada)
  ...
  [/A4000/i,              77],
  [/A40\b/i,             150],
  [/V100S/i,              89],   // V100S 32GB
  [/P100/i,               18],
  [/K80/i,                 6],
  [/MI300X/i,            5300],  // AMD MI300X
  [/MI250X/i,            1640],
  [/MI250\b/i,           1640],
  [/MI210\b/i,            383],
];
...
const PROVIDER_BILLING: Record<string, ProviderBillingInfo> = {
  ...
  'Scaleway': {
    ...
    egressCostPerGB: 0.01,
    networkBandwidthGbps: 25,
    complianceClaims: ['ISO 27001', 'GDPR'],
    storageWarning: '',
    billingNote: 'EU-based. Stop instance to pause GPU billing. Block volumes billed separately (~€0.04/GB/mo).',
  },
  'Hyperstack': {
    diskType: 'NVMe SSD',
    storageCostPerGBMonth: null,
    ...
    complianceClaims: [],
    storageWarning: '',
    billingNote: 'NVIDIA-partner cloud. Verify storage billing details before long-running jobs.',
  },
  'Genesis Cloud': {
    diskType: 'NVMe SSD (included)',
    storageCostPerGBMonth: 0,
    billedWhenStopped: false,
    persistentDisk: true,
    egressCostPerGB: 0,
    networkBandwidthGbps: 10,
    complianceClaims: ['ISO 27001'],
    storageWarning: '',
    billingNote: 'Iceland data center, renewable energy. Storage and egress included in instance price.',
  },
  'OVHcloud': {
    diskType: 'Local SSD / Block Storage',
    storageCostPerGBMonth: 0.04,
    billedWhenStopped: false,
    persistentDisk: true,
    egressCostPerGB: 0.011,
    networkBandwidthGbps: 10,
    complianceClaims: ['ISO 27001', 'SOC 2', 'GDPR', 'HDS'],
    storageWarning: '',
    billingNote: 'Major EU cloud. Competitive egress pricing. Stop instance to pause GPU billing.',
  },
  'CoreWeave': {
    diskType: 'NVMe SSD / Shared File System',
    storageCostPerGBMonth: 0.04,
    billedWhenStopped: false,
    persistentDisk: true,
    egressCostPerGB: 0.10,
    networkBandwidthGbps: 400,
    complianceClaims: ['SOC 2 Type II', 'ISO 27001'],
    storageWarning: '',
    billingNote: 'NVIDIA-backed, InfiniBand fabric, enterprise-grade. Contact sales for committed pricing.',
  },
  'Crusoe': {
    diskType: 'NVMe SSD',
    storageCostPerGBMonth: null,
    ...
    complianceClaims: [],
    storageWarning: '',
    billingNote: 'Runs on stranded/flared gas energy. Competitive pricing on H100 clusters.',
  },
  'Latitude.sh': {
    diskType: 'NVMe SSD (bare metal)',
    storageCostPerGBMonth: 0,
    billedWhenStopped: false,
    persistentDisk: true,
    egressCostPerGB: 0,
    ...
    complianceClaims: [],
    storageWarning: '',
    billingNote: 'Bare metal GPU servers. Storage and bandwidth included. Hourly or monthly billing.',
  },
};
...
const PROVIDER_FRICTION_BASE: Record<string, FrictionLevel> = {
  ...
  'Scaleway':     'Self-serve',
  'Hyperstack':   'Self-serve',
  'Genesis Cloud':'Self-serve',
  'OVHcloud':     'Self-serve',
  'Crusoe':       'Self-serve',
  'Latitude.sh':  'Self-serve',
};
